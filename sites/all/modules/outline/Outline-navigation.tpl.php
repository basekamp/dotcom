<?php
// $Id: Outline-navigation.tpl.php,v 1.2 2008/08/13 10:50:31 augustin Exp $

/**
 * @file Outline-navigation.tpl.php
 ...
 *   Provided as an option. Not used by default.
 *
 * @see template_preprocess_outline_navigation()
 */
?>
<?php if ($tree || $has_links): ?>
  <div id="outline-navigation-<?php print $book_id; ?>" class="outline-navigation">
    <?php print $tree; ?>
